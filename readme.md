...
To create the files in this git repo we've already to run `mvn archetype:generate` from http://maven.apache.org/guides/getting-started/maven-in-five-minutes.html
